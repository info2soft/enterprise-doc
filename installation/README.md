...
2、一般情况下工作机模块、灾备机模块和控制机模块分别独立部署在不同的服务器上，但也可任意部署在同一台或者两台机器上。比如，在服务器A上安装工作机模块，在服务器B上安装控制机模块和灾备机模块。
       ...
       针对上述的三个模块，i2提供两类软件安装包：info2soft-i2node-6.1-_安装包和info2soft-ctrlcenter-6.1-_安装包，其中info2soft-i2node-6.1-_安装包包含工作机模块和灾备机模块，info2soft-ctrlcenter-6.1-_安装包包含控制机模块。
...
| info2soft-i2node-6.x-xxxx.el5.i386.rpm | RHEL5、CentOS5系列\(el5、el5PAE、el5xen\) 32位 |
| info2soft-i2node-6.x-xxxx.el5.x86\_64.rpm | RHEL5、CentOS5系列\(el5、el5PAE、el5xen\) 64位 |
...
| info2soft-i2node-6.x-xxxxx.uek7.x86\_64.rpm |  |
...
| --- | --- |
| info2soft-ctrlcenter-6.x-xxxx.exe | Windows XP SP3、Windows 7、 |
| info2soft-ctrlcenter-6.x-xxxx.el5.i386.rpm | RHEL5、CentOS5以上系列 32位 |
| info2soft-ctrlcenter-6.x-xxxx.el5.x86\_64.rpm | RHEL5、CentOS5以上系列 64位 |
...
| info2soft-ctrlcenter-6.x-xxxxx.sles.11sp3.x86\_64.rpm |  |
| info2soft-ctrlcenter-6.x-xxxxx.sles.11sp4.x86\_64.rpm |  |
