...
* “支持瞬时恢复”：只有勾选了此选项的规则才能建瞬时恢复规则；

对于Hyper-V虚拟平台，高级设置如下图：

![](/assets/V7.120191023184206.png)
...
*   “瞬时恢复”：可直接添加/编辑恢复原虚机或新建虚机的瞬时恢复任务；
*   “查看日志”：查看此虚机的规则日志；
*   “查看流量图”：查看此虚机的备份流量信息；
*   “查看统计信息”：查看此虚机的备份统计信息；

组操作栏可用操作：
*   “修改”：修改虚机备份规则，只能修改备份策略和带宽控制选项，针对周期规则还可以添加新的虚机；注意：如果规则已经开始运行，此时修改带宽控制，则不会立即生效，周期规则在下一次执行时才会生效，一次性规则会继续使用修改之前的带宽控制选项，所以建议在规则非运行状态修改带宽控制。
