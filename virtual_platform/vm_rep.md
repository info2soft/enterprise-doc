...
虚拟机复制，目标虚拟平台上也会有原平台一样的虚拟机，并且源机变化的数据会根据同步策略，定时同步到目标虚机。

控制机管理界面，通过 虚拟化支持-&gt;虚机复制，来添加复制规则，复制规则添加页面如下：
...
![说明: 1](/assets/V7.120191023190016.png)
...
Hyper-V虚机迁移和虚机复制，如果虚机带有vhd磁盘，只会运行一次，后面的增量会跳过，规则变为完成。
