...
![说明: 1](/assets/V6.120181225181105.png)
...
（2）如果一个虚机已经加了备份规则，备份规则是周期任务，备份规则处于运行或者空闲状态，此时添加此虚机的恢复任务，提交时，会提示规则冲突，需要先停止此虚机的备份规则，再添加恢复任务，可添加成功，恢复任务添加成功后，且在运行状态时，此时再去启动备份规则，会报启动失败，需要等恢复任务完成；

（3）针对Vcenter虚拟平台，对一个虚机备份规则，已经加了一个即时恢复任务，再添加一个即时恢复任务，提交时，会提示规则冲突，需要等上一个恢复任务完成，再添加恢复任务，可添加成功；
