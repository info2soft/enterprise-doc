...
*    “创建新虚机”：不勾选表示恢复到原来的虚机，勾选表示恢复到新创建的虚机；Hyper-V平台不支持恢复到原机；
...
*    “目标平台”：恢复的目标虚拟平台；
*    “数据中心”：目标虚拟平台的数据中心；Hyper-V平台不支持此选项；
*    “主机名称”：目标虚拟平台的主机名称；Hyper-V平台选项显示为Hyper-V主机名称；
*    “数据存储”：目标虚拟平台的数据存储磁盘；
*    “处理器数量”：根据需求设定目标虚机的处理器数量；
*    “处理器核心数量”：根据需求设定目标虚机的处理器核心数量；Hyper-V平台不支持此选项；
*    “内存”：根据需求设定目标虚机的内存大小；
